...
const DEFAULT_TASKS = {
  ...
  bonus: [
    ...
    { id: 'tidy_morning', text: 'לסדר את הבית בבוקר', points: 15, icon: '🏠' },
    { id: 'tidy_noon', text: 'לסדר את הבית בצהרים', points: 15, icon: '🏠' },
    { id: 'tidy_night', text: 'לסדר את הבית בערב', points: 15, icon: '🏠' },
